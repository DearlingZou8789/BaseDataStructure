...
//初始化两栈共享空间结构
void SqDoubleStackInit(SqDoubleStack *S)
{
...
//判断两栈共享空间结构是否为空
Status SqDoubleEmpty(SqDoubleStack *S)
{
    if (S->top1==-1 && S->top2==STACKMAXSIZE)
    {
        return OK;
    }
    return ERROR;
...
//插入元素e为新的栈顶元素
Status SqDoublePush(SqDoubleStack *S, SElemType e,
                    int stackNumber)
{
...
Status SqDoublePop(SqDoubleStack *S, SElemType e,
                   int stackNumber)
{
    if (stackNumber==1)
    {
